...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (averagePopulationSpan) averagePopulationSpan.textContent = formatNumberWithCommas(Math.round(averagePopulation));
    if (totalPopulationSpan) totalPopulationSpan.textContent = formatNumberWithCommas(totalPopulation);
});
